                        ...
                        <table class="table table-lg text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="col-md-5">
                                    ...
                                    <div class="media-left">
                                        <h5 class="text-semibold no-margin">2,458
                                            <small class="text-danger text-size-base"><i class="icon-arrow-down12"></i>
                                                (- 4.9%)
                                            </small>
                                        </h5>
                                        <ul class="list-inline list-inline-condensed no-margin">
                                ...
                                <td class="text-right col-md-2">
                                    <a href="#" class="btn bg-indigo-300"><i class="icon-statistics position-left"></i>
                                        View report</a>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                            ...
                            <tr>
                                <td>
                                    <div class="media-left media-middle">
                                        <a href="#"><img src="assets/images/brands/bing.png" class="img-circle img-xs"
                                                         alt=""></a>
                                    </div>
                                    <div class="media-left">
                            ...
                            <tr>
                                <td>
                                    <div class="media-left media-middle">
                                        <a href="#"><img src="assets/images/brands/amazon.png" class="img-circle img-xs"
                                                         alt=""></a>
                                    </div>
                                    <div class="media-left">
                    ...
                    <div class="table-responsive">
                        <table class="table table-xlg text-nowrap">
                            ...
                            <tr>
                                ...
                                <td class="text-right col-md-2">
                                    <a href="#" class="btn bg-teal-400"><i class="icon-statistics position-left"></i>
                                        Report</a>
                                </td>
                            </tr>
                            </tbody>
                    ...
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="media-left media-middle">
                                        <a href="#"><img src="assets/images/demo/users/face15.jpg"
                                                         class="img-circle img-xs" alt=""></a>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="media-left media-middle">
                                        <a href="#"><img src="assets/images/demo/users/face3.jpg"
                                                         class="img-circle img-xs" alt=""></a>
                                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="media-left media-middle">
                                        <a href="#"><img src="assets/images/demo/users/face8.jpg"
                                                         class="img-circle img-xs" alt=""></a>
                                    </div>
                                ...
                                <ul class="media-list content-group">
                                    ...
                                    <li class="media stack-media-on-mobile">
                                        <div class="media-left">
                                            <div class="thumb">
                                                <a href="#">
                                                    <img src="assets/images/demo/flat/15.png"
                                                         class="img-responsive img-rounded media-preview" alt="">
                                                    <span class="zoom-image"><i class="icon-play3"></i></span>
                                                </a>
                                            </div>
